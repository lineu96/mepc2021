...
table2 <- freq_n_ord(quest_21$instituicao)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_21$instituicao),
...
compara$Ano <- c(rep('2021',12), rep('2020',11))
...
<center>
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
fim_grad <- subset(quest_21,quest_21$fim_grad<2021)
...
compara$Ano <- c(rep('2019',4), rep('2020',4), rep('2021',4))
...
artigos <- subset(quest_21, artigos >= 0)
...
artigos <- data.frame(artigos = c(artigos_19$td_artigo,
...
materias_est <- subset(quest_21, materias_est >= 0)

pander(tab_classes(materias_est$materias_est))
```
</center>
...
materias_n_est <- subset(quest_21, materias_n_est >= 0)

pander(tab_classes(materias_n_est$materias_n_est))
```
</center>
...
<center>
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
pander(posicao(materias_n_est$materias_n_est))
pander(dispersao(materias_n_est$materias_n_est))
```
</center>
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
table <- as.data.frame(table(materias_n_est$materias_n_est))
table$Var1 <- as.numeric(as.vector(table$Var1))
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
ggplot(materias_n_est, aes(x=materias_n_est)) +
  geom_histogram(col=1,
                 lwd=1) + 
  xlab("Número de disciplinas") +
  ylab("Frequência") +
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
ggplot(data = materias_n_est, 
       mapping = aes(y=materias_n_est, x='1')) +
  stat_boxplot(geom ='errorbar')+
  geom_boxplot(alpha = 1)+
  stat_summary(fun.y=mean, 
               geom="point", 
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
ggplot(materias_n_est) + 
  geom_histogram(aes(x=materias_n_est,
                     y=..density..), 
                 position="identity",
                 col = 1,
                 lwd = 1) + 
  geom_density(aes(x=materias_n_est,
                   y=..density..),
               col = 4,
               lwd = 1) + 
  xlab("Número de disciplinas") +
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
p1 = ggplot(materias_n_est, aes(x=materias_n_est)) +
  geom_histogram(col=1,
                 lwd=1) + 
  ylab("Frequência") +
  xlab("") +
...
materias_n_est_21 <- subset(quest_21,materias_n_est>=0)
materias_n_est_20 <- subset(quest_20,td_estatPGrad>=0)
materias_n_est_19 <- subset(quest_19,td_estatPGrad>=0)

materias_n_est <- data.frame(
  materias_n_est = c(materias_n_est_19$td_estatPGrad,
                      materias_n_est_20$td_estatPGrad,
                      materias_n_est_21$materias_n_est),
           ano = c(rep(2019,nrow(materias_n_est_19)),
                   rep(2020,nrow(materias_n_est_20)),
                   rep(2021,nrow(materias_n_est_21))))
...
import_met_est <- subset(quest_21, import_met_est >= 0)

pander(freq_n_ord(import_met_est$import_met_est))
```
</center>
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
table <- as.data.frame(table(import_met_est$import_met_est))
table$Var1 <- as.numeric(as.vector(table$Var1))
...
ggplot(import_met_est) + 
  geom_histogram(aes(x=import_met_est,
                     y=..density..), 
                 position="identity",
                 col = 1,
                 lwd = 1) + 
  geom_density(aes(x=import_met_est,
                   y=..density..),
               col = 4,
               lwd = 1) + 
  xlab("Valor") +
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
p1 = ggplot(import_met_est, aes(x=import_met_est)) +
  geom_histogram(col=1,
                 lwd=1) + 
  ylab("Frequência") +
  xlab("") +
