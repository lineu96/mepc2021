...
Visando uma análise mais eficiente, foi feita uma série de tratamentos nos dados brutos.
...
names(quest_21) <-
  c('data_hora', 'instituicao', 'setor_ufpr', 'atividade_ies',
    ...
    'covid_aprendizado', 'covid_ere', 'dificuldade_ere', 'covid_conclusao', 'idade_foto', 'kiki_bouba', 'quadrados')
